...
class CalendarStrip extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (!this.compareDates(prevProps.selectedDate, this.props.selectedDate)) {
      ...
      weekData = this.updateWeekData(startingDate.startingDate, selectedDate.selectedDate, this.props)
    }

    if (!updateState && !this.compareDates(prevProps.startingDate, this.props.startingDate)) {
      updateState = true
      startingDate = { startingDate: this.setLocale(moment(this.props.startingDate)) }
      weekData = this.updateWeekData(startingDate.startingDate, this.state.selectedDate, this.props)
    }

    if (
      !updateState &&
      (JSON.stringify(prevProps.datesBlacklist) !== JSON.stringify(this.props.datesBlacklist) ||
        JSON.stringify(prevProps.datesWhitelist) !== JSON.stringify(this.props.datesWhitelist) ||
        JSON.stringify(prevProps.customDatesStyles) !== JSON.stringify(this.props.customDatesStyles))
    ) {
      updateState = true
  ...
  render() {
    ...
    return (
      <View style={[styles.calendarContainer, { backgroundColor: this.props.calendarColor }, this.props.style]}>
        <View style={[this.props.innerStyle, { height: this.state.height }]} onLayout={this.onLayout.bind(this)}>
          ...
          <View style={styles.datesStrip}>
            ...
            {this.props.showDate ? <View style={styles.calendarDates}>{datesRender}</View> : calendarHeader}
